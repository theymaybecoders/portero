...
FakeWeb.register_uri(:get, "https://api.foursquare.com/v2/venues/search?client_id=1&client_secret=1&limit=50&radius=1000&v=20120709&ll=38.585287%2C-90.40936", body: File.read(File.join(File.dirname(__FILE__), '..', 'data', 'foursquare_without_query.json')))
...
FakeWeb.register_uri(:get, "https://maps.googleapis.com/maps/api/place/search/json?key=1&radius=1000&location=38.585287%2C-90.40936&sensor=false", body: File.read(File.join(File.dirname(__FILE__), '..', 'data', 'google_places_without_query.json')))